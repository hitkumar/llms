...
from rasbt_llms_from_scratch.llama3 import LLAMA32_CONFIG_1B, Llama3Model, Tokenizer
...
train_dataloader = DataLoaderLite(
    ...
    split="train",
    root_dir="/home/htkumar/llms/gpt2_karpathy/data/fineweb_llama3",
)
...
config = LLAMA32_CONFIG_1B.copy()
model = Llama3Model(config)

experiment_id = "llama31_1b"
